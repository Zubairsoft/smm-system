...
use App\Http\Resources\Shops\Products\ProductsResource;
...
class ProductController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        return sendSuccessResponse(__('messages.get_data'), ProductsResource::collection($products));
    }
    ...
    public function store(StoreProductData $request): JsonResponse
    {
        ...
        return sendSuccessResponse(__('messages.create_data'), ProductResource::make($product));
    }
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return sendSuccessResponse(__('messages.get_data'), ProductResource::make($product));
    }
    ...
    public function update(UpdateProductData $request, string $id): JsonResponse
    {
        ...
        return sendSuccessResponse(__('messages.update_data'), ProductResource::make($product));
    }
